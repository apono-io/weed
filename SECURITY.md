...
If you believe you have found a security vulnerability in `weed`, please report
...
Security fixes are applied to the latest released version of `weed`. We recommend
